...
I trained a logistic classifier using `scikit-learn` that predicts the turnover status of employees. The takes 
in an employee's data as an input and outputs a turnover prediction. The classifier has internal weightings on 
each category of data. 

Here are my results dashboard:

<ImageSrc src="https://f004.backblazeb2.com/file/websitev1/Unessay1.png"caption="Figure: Feature Weightings from Classifier" />
<ImageSrc src="https://f004.backblazeb2.com/file/websitev1/Unessay2.png"  caption="Figure: Turnover inducing factors" />
