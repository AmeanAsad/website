...
## About This Project
 ...
 I decided to stop paying for theoriginal domain, however the project is still hosted on Heroku. 
...
significantly impacted my SEO. I should have probably looked into server-side rendering to increase
the traffic through my site.
...
such as the map visualizations, the dashboard, and the search functionality.
 ...
 <Button rounded="lg" color="brand.red"> Test </Button> 
