...
## About This Project
 ...
 contact the disease where there are 4 possible states to a node at a given time:
 infected, diseases, recovered, susceptible. Obviously, this is a very simple model of disease spread, but I
 ...
 REST API were a client-side animation library does the work. I ran into some performance
 issues attempting to run each users' requested animation on 7$ hobby server. I also wanted
